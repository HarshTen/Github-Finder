...
function regenerateVerify(){
    ...
    if(!empty($_GET['reverify']) && !empty($_GET['email'])){
        ...
        $body = "Please click on the button below to confirm subscription: <a href='localhost/comics/check.php?id=$verification_token'><br><div style='text-align:center;'><button><strong>Click here to Verify</strong></button></div></a>";
...
function addSubscriber($email){
    ...
    $mail = "$email";
    $name = "xkcd comics on your mail!";
    $body = "Please click on the button below to confirm subscription: <a href='localhost/comics/check.php?id=$verification_token'><br><button><div style='text-align:center;'><strong>Click here to Verify</strong></div></a></button>";
    $subject = "Verification mail";
